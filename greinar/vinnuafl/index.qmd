...
table_dat |> 
  ...
  cols_label(
    ...
    dags = "Dagsetning",
    starfandi = "Fjöldi starfandi",
    hlutf = "% af starfandi"
  ) |> 
  fmt_date(
    columns = dags, date_style = "day_m_year"
  ) |> 
  fmt_number(
    columns = "starfandi", 
    decimals = 0
  ...
  tab_source_note(
    md("Heimild: [Gögn Hagstofu um fjölda starfandi samkvæmt skrám](https://px.hagstofa.is/pxis/pxweb/is/Samfelag/Samfelag__vinnumarkadur__vinnuaflskraargogn/VIN10052.px)")
  ) |> 
  tab_options(
...
ggsave(
  plot = p,
  filename = "figures/figure_hlutf_aukning_2018.png",
  width = 8, height = 0.5 * 8, scale = 1.2,
  dpi = 300
)
...
![](figures/figure_hlutf_aukning_2018.png){.column-page}
...
ggsave(
  plot = p,
  filename = "figures/figure_hlutf_aukning_2015.png",
  width = 8, height = 0.5 * 8, scale = 1.2,
  dpi = 300
)
```
...
![](figures/figure_hlutf_aukning_2015.png){.column-page}
