...
plot_dat <- d |> 
  ...
  mutate(
    ...
    bygg_per_pers = slide_dbl(bygg_per_pers, sum, .before = 5, .complete = T),
    .by = sveitarfelag
  ) |> 
  mutate(
  ...
  mutate(
    fullordin_per_bygg = ifelse(ar == 2022, fullordin_per_bygg, NA_real_),
    text1 = str_c(
      "<b>", sveitarfelag, "</b>", "\n",
    ...
    text3 = str_c(
      "<b>", sveitarfelag, "</b>", "\n",
      "Fjölgin fullorðinna: ", hlutf(mannf_index), "\n",
    ...
    var2 = "Nýjar fasteignir á 1.000 fullorðna síðustu 5 ár",
    var3 = "Samanburður á fólksfjölgun og íbúðabyggingu"
  )

pd <- highlight_key(plot_dat, ~sveitarfelag, "Veldu sveitarfélag með nafni eða smelltu á myndirnar (Haltu inni SHIFT til að velja fleiri)")
