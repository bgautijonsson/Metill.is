...
```{r data}
if (!file.exists("data/data.arrow")) {
  init_db()
...
p <- plot_dat |> 
  ...
  geom_point(aes(x = eftir, colour = "2022"), size = 2.5) +
  ...
  annotate(
    ...
    geom = "text",
    label = str_c(
      "Akureyrarbær er eina sveitarfélagið þar sem",
      "\nfasteignum fjölgaði hraðar en fullorðnum"
    ),
    vjust = 1,
    hjust = 0,
    color = "grey40",
