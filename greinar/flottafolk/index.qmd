...
make_plot(
  ...
  end_date = clock::date_build(2024, 3, 1),
...
make_plot(
  ...
  scaling_var = "per_pop",
  start_date = clock::date_build(2022, 3, 1),
  end_date = clock::date_build(2024, 2, 1),
...
make_plot(
  ...
  start_date = clock::date_build(2022, 3, 1),
  end_date = clock::date_build(2024, 1, 1),
...
make_samantekt(
  height = 1 * 16,
  width = 16,
  end_date = clock::date_build(c(2024, 2023, 2024), c(2, 10, 2)),
  number_labels = label_number(big.mark = ".", decimal.mark = ",")
)
```
