...
p <- crossing(
  ...
  mutate(
    ...
    Kópavogsbær = 0.00117 * fasteignamat,
    Reykjavíkurborg = 18322 + 798.31 * fm,
    Garðabær = 0.00152 * fasteignamat,
    Seltjarnarnesbær = 0.00228 * fasteignamat,
    fm2 = glue("{fm}~m^2") |> 
      fct_reorder(fm)
  ) |> 
...
ggsave(
  plot = p,
  filename = here("greinar", "fasteignagjold", "figures", "compare_vatnsfraveitugjold_rvk_kop.png"),
