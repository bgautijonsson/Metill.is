...
* **Hælisleitandi (e. asylum applicant):** Einstaklingur sem fær ekki tímabundna vernd heldur þarf að ganga í gegnum persónulegra ferli þar sem málsmeðferð þarf að skera út um hvort einstaklingur þurfi á hæli að halda.
...
p1 <- d |> 
  ...
  labs(
    x = NULL,
    y = NULL,
    title = "Hvar sækja flestir einstaklingar um hæli (efnisleg meðferð)?",
    subtitle = "Fjöldi í mars 2022",
    caption = caption
  )
...
p1 <- d |> 
  ...
  labs(
    x = NULL,
    y = NULL,
    title = "Hvar eru flestar ákvarðanir um stöðu hælisleitenda (efnisleg meðferð) teknar á mánuði?",
...
p1 <- d |> 
  ...
  labs(
    x = NULL,
    y = NULL,
    title = "Hvar er flestum einstaklingum veitt hæli (efnisleg meðferð) á mánuði?",
    subtitle = "Fjöldi í apríl 2022",
    caption = caption
  )
...
p <- (
  ...
  plot_annotation(
    title = "Hvaða hlutfall umsókna um hæli er samþykkt?",
    subtitle = "Sýnt sem hlutfall allra umsókna um hæli (efnisleg meðferð)",
    caption = caption
  )
...
![](Figures/percent_positive_saman_2.png){.column-page}
