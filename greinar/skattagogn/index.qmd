...
d <- bind_rows(
  ...
  mutate(
    ...
    breyting = breyting / (ar - min(ar)),
    medaltal_breyting =  medaltal /  medaltal[ar == min(ar)] - 1,
    medaltal_breyting = medaltal_breyting / (ar - min(ar)),
...
(
  d |> 
    ...
    labs(
      x = "Tíundamörk",
      y = "Meðalbreyting á ári frá 1990",
      title = "Hvernig hafa atvinnu- og heildartekjur eftir aldurs- og tekjuhópum breyst síðan 1990?"
    )
) |> 
