...
caption <- "Mynd eftir @bggj hjá metill.is byggð á gögnum Eurostat um fólksflutninga: https://metill.is/greinar/flottafolk\nGögn og kóði: https://github.com/bgautijonsson/Metill.is/tree/master/greinar/flottafolk"
...
end_date <- clock::date_build(2023, 8, 1)
...
end_date <- clock::date_build(2023, 9, 1)
