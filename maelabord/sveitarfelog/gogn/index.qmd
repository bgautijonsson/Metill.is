...
percent_vars <- c(
  ...
  "Handbært fé á íbúa",
  "Launagjöld sem hlutfall af gjöldum",
  ...
  "Veltufé sem hlutfall af tekjum",
  "Veltufjárhlutfall"
)
...
throun_data <- d |> 
  select(
    ...
    "Launagjöld á íbúa" = launagjold_per_ibui,
    "Launagjöld sem hlutfall af gjöldum" = launagjold_hlutf_gjold,
